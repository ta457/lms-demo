<div class="flex justify-between items-center border-b border-gray-200 dark:border-gray-600 w-full pb-2">
  ...
  @if (Auth::user()->role == '3')
  <a class="hover:cusor-pointer" href="/subsection/{{ $id }}/edit-link">
    <svg class="w-5 h-5 text-gray-400 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
