<button class="hidden" id="defaultModalButton2" data-modal-target="defaultModal2" data-modal-toggle="defaultModal2">btn2</button>
<div id="defaultModal2" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <!-- Modal body -->
            <form action="" id="subsec-form2" method="POST"  enctype="multipart/form-data">
                @csrf
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <input class="hidden" type="number" name="section_id" id="section_id">
                    <input class="hidden" type="number" name="type" id="type" value="2">
                    <div>
                        <label for="title"
