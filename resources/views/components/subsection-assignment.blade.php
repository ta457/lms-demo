<div class="border-b border-gray-200 dark:border-gray-600 w-full pb-2">
  <div class="flex justify-between items-center w-full">
    <a class="flex gap-4 items-center group"
      ...
      @endif
    >
      <div class="w-10 h-10 rounded-lg bg-gray-200 dark:bg-gray-700 dark:group-hover:bg-gray-600 flex items-center justify-center group">
    ...
    <a class="hover:cusor-pointer" href="/subsection/{{ $id }}/edit-assignment">
      <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-700 dark:text-gray-400 dark:hover:text-white" aria-hidden="true"
