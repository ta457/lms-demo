<x-app-layout>
  ...
  <div class="grid lg:grid-cols-6 h-screen">
    ...
    <x-admin-sidebar>
      ...
      <li>
        <a href="/admin-dashboard/faculties"
          class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-white dark:hover:bg-gray-700 group">
          <svg
    ...
    {{--
    <x-admin-table :columns="$columns" :data="$usersData" /> --}}
